  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section id="top" className="relative overflow-hidden bg-primary pt-20 text-primary-foreground">
        ...
        <div className="pointer-events-none absolute inset-y-0 right-0 hidden w-1/2 bg-[url('/nestora-hero.png')] bg-cover bg-center opacity-35 lg:block" /><div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-primary via-primary/90 to-transparent lg:w-3/4" />
      </section>
